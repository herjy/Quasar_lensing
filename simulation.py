...
def simulation_(sample_ = sample):
    '''
    ...
    return generate_damped_RW(np.sort(sample), tau=tau, z=zs, SFinf=SFinf, xmean=xmean,random_state=5)

def plot(mag0,mag1,mag2,mag3, delay,t=t_drive_new):
    '''
